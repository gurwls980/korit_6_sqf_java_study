        ...
        while(isRun) {
            ...
            switch (selectedMenu) {
                ...
                case "2":
                    ...
                    findIndex = arrayUtils.findNameByName(names, modifyName);
                    if(findIndex == -1) {
                ...
                case "3":
                    ...
                    findIndex = arrayUtils.findNameByName(names, removeName);
                    if(findIndex == -1) {
                        System.out.println("해당 이름은 존재하지 않습니다.");
                        break;
                    }
                ...
                case "4":
                    ...
                    findIndex = arrayUtils.findNameByName(names, findName);
                    if(findIndex == -1) {
